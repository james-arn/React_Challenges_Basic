  ...
  return (
    <div>
      ...
      <div className="carouselTile">
        <Carousel_tile image={outdoorGetawaysImg} title="Outdoor Getaways" />
        <Carousel_tile image={uniqueStaysImg} title="Unique Stays" />
        <Carousel_tile image={entireHomesImg} title="Entire Homes" />
        <Carousel_tile image={petsAllowedImg} title="Pets Allowed" />
      </div>
    </div>
  );
};
